...
public class ViewSkinCup : Singleton<ViewSkinCup>
{
    public List<BaseSkinCup> baseSkins = new List<BaseSkinCup>();
    public SkinCupData skinsData;
    ...
    protected override void Awake()
    {
        ...
        {
            baseSkins.Add(skin.GetComponent<BaseSkinCup>());
        }
        SetSkinID();
    }
